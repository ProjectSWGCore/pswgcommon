 ...
 * @author Waverunner
 */
public class ChatInviteAvatarToRoom extends SWGPacket {
	public static final int CRC = getCrc("ChatInviteAvatarToRoom");

	private ChatAvatar avatar;
	private String room;

	public ChatInviteAvatarToRoom() {}

	public ChatInviteAvatarToRoom(ChatAvatar avatar, String room) {
		this.avatar = avatar;
		this.room = room;
	}
