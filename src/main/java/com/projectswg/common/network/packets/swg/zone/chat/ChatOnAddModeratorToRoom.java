 ...
 * @author Waverunner
 */
public class ChatOnAddModeratorToRoom extends SWGPacket {
	public static final int CRC = getCrc("ChatOnAddModeratorToRoom");
	...
	public ChatOnAddModeratorToRoom(ChatAvatar target, ChatAvatar moderator, int result, String room, int sequence) {
		this.target = target;
