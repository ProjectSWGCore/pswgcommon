...
public class GroupOpenLotteryWindow extends ObjectController {
	
	public static final int CRC = 0x043D;
	
	private long inventoryId;
	
	public GroupOpenLotteryWindow(long objectId, long inventoryId) {
		super(objectId, CRC);
		this.inventoryId = inventoryId;
	}
	
	public GroupOpenLotteryWindow(NetBuffer data) {
		super(CRC);
		decode(data);
	}
