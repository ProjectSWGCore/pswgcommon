...
import com.projectswg.common.encoding.EncodableBuilder.Companion.list

class GcwRegion() : Encodable2<GcwRegion>(builder) {
	
	var planetName: String = ""
	val zones = ArrayList<GcwRegionZone>()
	
	constructor(planetName: String, zones: Collection<GcwRegionZone>) : this() {
	...
	companion object {
		private val builder = EncodableBuilder(arrayOf(
			ascii(GcwRegion::planetName),
			list(GcwRegion::zones)
		))
	}
}
