...
public class DetailExtentParser extends CompositeExtentParser {
	
	public DetailExtentParser() {
		super();
	}
	
	public DetailExtentParser(CompositeExtent composite) {
		super(composite);
	}
	
	@Override
	public void read(IffForm form) {
		assert form.getTag().equals("DTAL");
	...
	public IffForm write() {
		return IffForm.of("DTAL", 0, super.write());
	}
